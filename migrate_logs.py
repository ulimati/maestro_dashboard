                ...
                if file.endswith(".xml"):
                    ...
                    try:
                        ...
                        for testcase in root.iter('testcase'):
                            ...
                            # Payload přesně odpovídá vašemu novému TestResultCreate modelu
                            payload = {
                                "test_name": test_name,
                                "status": status,
                                "duration": duration,
                            ...
                            if response.status_code == 200:
                                print(f"✅ Nahráno: {test_name} ({platform})")
                            else:
...
if __name__ == "__main__":
    # Nejprve se ujistěte, že vaše FastAPI (app.py) běží!
