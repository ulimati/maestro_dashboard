...
def get_all_test_data(platform_selection):
    ...
    # API platform - reads from logs/json
    if "API" in platform_selection:
        ...
        for file in os.listdir(json_dir):
            ...
            try:
                ...
                # run_id from filename (date+time)
                ...
                for result in item.get("results", []):
                    ...
                    # Error message from testResults
                    error_msg = ""
    ...
    # Android / iOS - reads from logs/logs_android or logs/logs_ios
